package com.supermarket.loyalityprogram.constants;

import java.math.BigDecimal;

public final class ApplicationConstants {

	public static final BigDecimal BOTTLE_REDEEM_VALUE = new BigDecimal(150);
	public static final BigDecimal BUCKS_REDEEM_VALUE = new BigDecimal(100);
	public static final BigDecimal MINIMUM_PURCHASE_VALUE = new BigDecimal(5);
